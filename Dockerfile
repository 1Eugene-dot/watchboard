...
# Update Title
RUN sed -i 's|<title>\[\[.AppTitle\]\]</title>|<title>VariableWatch Portal</title>|g' /usr/share/grafana/public/views/index.html
RUN sed -i 's|Loading VariableWatch|Loading Business Portal|g' /usr/share/grafana/public/views/index.html
...
## Update Title
    -exec sed -i 's|AppTitle="VariableWatch"|AppTitle="VariableWatch IOT Portal"|g' {} \; \
## Update Login Title
    -exec sed -i 's|LoginTitle="Welcome to VariableWatch"|LoginTitle="VariableWatch IOTPortal"|g' {} \; \
